...
export async function basculer(uid, idTache, tacheCompletee) {
  return instanceFirestore.collection(collUtil).doc(uid).collection(collTaches).doc(idTache).update('completee', tacheCompletee);
}